...
const introData = {
  ...
  beforeName: "I'm ",
  name: "Vedika Soni",
  afterName: ", an experienced Full Stack Developer in creating robust and scalable web applications using the MERN stack. ",
  contact: "Get in touch ",
  email: "hello@moivedi.com",
  mailTo: "mailto:hello@moivedi.com",
};
const Intro = () => {
